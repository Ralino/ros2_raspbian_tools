...
apt -y install build-essential cppcheck cmake libopencv-dev libpoco-dev python-empy python3-dev python3-catkin-pkg-modules python3-empy python3-nose python3-pip python3-setuptools python3-vcstool python3-yaml libtinyxml-dev libeigen3-dev
